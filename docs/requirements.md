...
`/thermal/actions/hold` and `/thermal/actions/release` remain absent unless both
feature settings name the v2 authority path. Building or deploying this code
